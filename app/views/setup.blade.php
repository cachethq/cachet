                        ...
                        {{ Form::open(['name' => 'SetupForm', 'class' => 'form-vertical', 'role' => 'form']) }}
                            <fieldset>
                                ...
                                <div class='form-group'>
                                    ...
                                    <input type='text' name='settings[app_name]' class='form-control' placeholder='{{ trans("forms.site_name") }}' value='{{ Input::old("settings.app_name", "") }}' required />
                                ...
                                <div class='form-group'>
                                    ...
                                    <input type='text' name='settings[app_domain]' class='form-control' placeholder='{{ trans("forms.site_domain") }}' value='{{ Input::old("settings.app_domain", "") }}' required />
                            ...
                            <fieldset>
                                ...
                                <div class='form-group'>
                                    ...
                                    <input type='text' name='user[username]' class='form-control' placeholder='{{ trans("forms.username") }}' value='{{ Input::old("user.username", "") }}' required />
                                ...
                                <div class='form-group'>
                                    ...
                                    <input type='email' name='user[email]' class='form-control' placeholder='{{ trans("forms.email") }}' value='{{ Input::old("user.email", "") }}' required />
                                ...
                                <div class='form-group'>
                                    ...
                                    <input type='password' name='user[password]' class='form-control' placeholder='{{ trans("forms.password") }}' value='{{ Input::old("user.password", "") }}' required />
