...
class EnablePluginMigrationsHandler
{
    /**
    ...
    /**
     * Create a new enable plugin migrations handler.
     *
     ...
     * Handle the event.
     *
     * @param \CachetHQ\Cachet\Bus\Events\Plugin\PluginWillBeEnabledEvent $event
     *
     * @return void
     */
    public function handle(PluginWillBeEnabledEvent $event)
    {
