...
return [
    ...
    */
    ...
    |--------------------------------------------------------------------------
    |
    | Whether to allow incident feeds to be generated.
    |
    */
   ...
   /*
    ...
    |--------------------------------------------------------------------------
    |
    | Whether to enable going to previous incidents in the timeline.
    |
    */
   ...
   /*
    ...
    |--------------------------------------------------------------------------
    |
    | Which timeline header to display.
    |
    */

    'timeline_header' => 'past',
