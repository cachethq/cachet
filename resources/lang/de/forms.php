...
return [
    ...
    'components' => [
        ...
        'enabled'     => 'Komponente aktiviert?',

        'groups' => [
            'name'               => 'Name',
            'collapsing'         => 'Sichtbarkeit der Gruppe',
    ...
    'settings' => [
        ...
        'theme' => [
            ...
            'fullwidth-banner'        => 'Banner auf volle Breite aktivieren?',
    ...
    'user' => [
        ...
        'gravatar'       => 'Ändern Sie Ihr Profilbild mit Gravatar.',
        ...
        'team' => [
            'description' => 'Laden Sie Ihre Team-Mitglieder ein, indem Sie hier ihre E-Mail Adressen angeben.',
            'email'       => 'Email #:id',
        ],
    ],
