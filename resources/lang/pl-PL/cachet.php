...
return [
    ...
    'subscriber' => [
        ...
        'email' => [
            ...
            'verify'             => [
                'text'   => "Proszę potwierdź swoją subskrypcję email dla :app_name status updates.\n:link",
                'html'   => '<p>Proszę potwierdź swoją subskrypcję email dla :app_name status updates.</p>',
                'button' => 'Potwierdź subskrypcję',
            ],
            'maintenance' => [
                'subject' => '[Obsługa planowana] :name',
            ],
            'incident' => [
                'subject' => '[Nowy Wątek] :status: :name',
            ],
            'component' => [
