        ...
        <div class="form-bg">
            ...
            <form method="POST" action="{{ cachet_route('auth.login', [], 'post') }}" accept-charset="UTF-8" autocomplete="off" name="{{ str_random(10) }}">
                ...
                <div class="form-group">
                    ...
                    <input autocomplete="off" class="form-control login-input" placeholder="{{ trans('forms.login.login') }}" required="required" name="username" type="text" value="{{ request()->old('username') }}" autofocus>
                </div>
                <div class="form-group">
