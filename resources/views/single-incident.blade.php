...
@section('title', Illuminate\Support\Arr::get($incident->meta, 'seo.title', $incident->name).' | '.$siteTitle)

@section('description', Illuminate\Support\Arr::get($incident->meta, 'seo.description', trans('cachet.meta.description.incident', ['name' => $incident->name, 'date' => $incident->occurred_at_formatted])))
