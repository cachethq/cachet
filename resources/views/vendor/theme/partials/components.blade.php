...
<ul class="list-group components">
    ...
    <div class="group-items {{ $componentGroup->is_collapsed ? "hide" : null }}">
        @each('theme::partials.component', $componentGroup->enabled_components()->orderBy('order')->get(), 'component')
    </div>
    @endif
</ul>
@endforeach
...
<ul class="list-group components">
    ...
    @each('theme::partials.component', $ungroupedComponents, 'component')
</ul>
@endif
