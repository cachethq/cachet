            ...
            <form class="form-vertical" name="IncidentForm" role="form" method="POST" autocomplete="off">
                ...
                <fieldset>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="seo[title]" class="form-control"  value="{{ Arr::get($incident->meta, 'seo.title', '')  }}">
                    </div>
                    <div class="form-group">
                        <label>{{ trans('forms.seo.description') }}</label> <small class="text-muted">{{ trans('forms.optional') }}</small>
                        <input type="text" name="seo[description]" class="form-control" value="{{ Arr::get($incident->meta, 'seo.description', '') }}">
                    </div>
                </fieldset>
