            ...
            <form class="form-vertical" name="ScheduleForm" role="form" method='POST' autocomplete="off">
                ...
                <fieldset>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" id="scheduled_at" name="scheduled_at" class="form-control flatpickr-time" data-date-format="Y-m-d H:i" value="{{ $schedule->scheduled_at_datetimepicker }}" required placeholder="{{ trans('forms.schedules.scheduled_at') }}">
                    </div>
                    <div class="form-group">
                        <label for="completed_at">{{ trans('forms.schedules.completed_at') }}</label>
                        <input type="text" id="completed_at" name="completed_at" class="form-control flatpickr-time" data-date-format="Y-m-d H:i" value="{{ $schedule->completed_at_datetimepicker }}" required placeholder="{{ trans('forms.schedules.completed_at') }}">
                    </div>
                </fieldset>
