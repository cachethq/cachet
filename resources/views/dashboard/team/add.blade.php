            ...
            <form name="UserForm" class="form-vertical" role="form" action="{{ cachet_route('dashboard.team.create', [], 'post') }}" method="POST">
                ...
                <fieldset>
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="username" value="{{ request()->old('username') }}" required placeholder="{{ trans('forms.user.username') }}">
                    </div>
                    <div class="form-group">
                        <label>{{ trans('forms.user.email') }}</label>
                        <input type="email" class="form-control" name="email" value="{{ request()->old('email') }}" required placeholder="{{ trans('forms.user.email') }}">
                    </div>
                    <div class="form-group">
