        ...
        @forelse($incidents as $incident)
            @php 
                if ($incident->component) {
                    $tagsArray = json_decode($incident->component->tags, true);
                }
            @endphp

            @if ($tag === null || ($incident->component && array_key_exists($tag, $tagsArray)) || !$incident->component || (!request()->input('withIncident') ))
